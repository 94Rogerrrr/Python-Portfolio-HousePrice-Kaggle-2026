...
2. 執行 Jupyter Notebook：打開 `[Portfolio]Kaggle_HousePricePrediction.ipynb` 即可重現資料清洗與預測結果。
...
|XGBoost Regression (CVxgbModel)|0.90|2.3k|26.1k|1035.64%|0.01277|0.13735|0.12457|15.7k| 8.812%|❌ 過擬合 |
